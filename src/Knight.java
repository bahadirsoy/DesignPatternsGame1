...
public class Knight extends Character{
    ...
    public Knight(int xPosition, int yPosition, ArrayList<GameObject> gameUnits){
        super(xPosition, yPosition, gameUnits);

        moveBehaviour = new Normal2StepMove();
        ...
        try {
            super.image = ImageIO.read(new File("C:\\Users\\oxika\\IdeaProjects\\DesignPatterns\\img\\knight.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
        ...
        for(Iterator<GameObject> o = gameUnits.iterator(); o.hasNext();){
            ...
            if(this.xPosition == object.xPosition && this.yPosition == object.yPosition){
                if(object instanceof Knight){
                    ...
                    System.out.println("Knight dealed " + this.damage + " damage to " + object.getClass().getName());
                    System.out.println(object.getClass().getName() + " dealed " + ((Character) object).damage + " to knight");
                    ...
                    if(((Trap) object).stunDuration > 0){
                        ...
                        System.out.println("Knight stepped " + object.getClass().getName());
