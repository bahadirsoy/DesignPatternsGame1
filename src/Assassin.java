...
public class Assassin extends Character{
    ...
    public Assassin(int xPosition, int yPosition, ArrayList<GameObject> gameUnits){
        super(xPosition, yPosition, gameUnits);

        moveBehaviour = new Diagonal1StepMove();
        ...
        try {
            super.image = ImageIO.read(new File("C:\\Users\\oxika\\IdeaProjects\\DesignPatterns\\img\\assassin.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
        ...
        for(Iterator<GameObject> o = gameUnits.iterator(); o.hasNext();){
            ...
            if(this.xPosition == object.xPosition && this.yPosition == object.yPosition){
                if(object instanceof Assassin){
                    ...
                    System.out.println("Assassin dealed " + this.damage + " damage to " + object.getClass().getName());
                    System.out.println(object.getClass().getName() + " dealed " + ((Character) object).damage + " to assassin");
                    ...
                    if(((Trap) object).stunDuration > 0){
                        ...
                        System.out.println("Assassin stepped " + object.getClass().getName());
