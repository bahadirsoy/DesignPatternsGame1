...
public class Goblin extends Character{
    ...
    public Goblin(int xPosition, int yPosition, ArrayList<GameObject> gameUnits){
        ...
        try {
            super.image = ImageIO.read(new File("C:\\Users\\oxika\\IdeaProjects\\DesignPatterns\\img\\goblin.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
        ...
        for(Iterator<GameObject> o = gameUnits.iterator(); o.hasNext();){
            ...
            if(this.xPosition == object.xPosition && this.yPosition == object.yPosition){
                if(object instanceof Goblin){
                    ...
                    System.out.println("Goblin dealed " + this.damage + " damage to " + object.getClass().getName());
                    System.out.println(object.getClass().getName() + " dealed " + ((Character) object).damage + " to goblin");
                    ...
                    if(((Trap) object).stunDuration > 0){
                        ...
                        System.out.println("Goblin stepped " + object.getClass().getName());
