...
public class Hero extends Character{
    ...
    public Hero(int xPosition, int yPosition, ArrayList<GameObject> gameUnits){
        ...
        try {
            super.image = ImageIO.read(new File("C:\\Users\\oxika\\IdeaProjects\\DesignPatterns\\img\\hero.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
        ...
        for(Iterator<GameObject> o = gameUnits.iterator(); o.hasNext();){
            ...
            if(this.xPosition == object.xPosition && this.yPosition == object.yPosition){
                if(object instanceof Hero){
                    ...
                    System.out.println("Hero dealed " + this.damage + " damage to " + object.getClass().getName());
                    System.out.println(object.getClass().getName() + " dealed " + ((Character) object).damage + " to hero");
                    ...
                    if(((Trap) object).stunDuration > 0){
                        ...
                        System.out.println("Hero stepped " + object.getClass().getName());
