...
public class Warrior extends Character{
    ...
    public Warrior(int xPosition, int yPosition, ArrayList<GameObject> gameUnits){
        ...
        try {
            super.image = ImageIO.read(new File("C:\\Users\\oxika\\IdeaProjects\\DesignPatterns\\img\\warrior.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
        ...
        for(Iterator<GameObject> o = gameUnits.iterator(); o.hasNext();){
            ...
            if(this.xPosition == object.xPosition && this.yPosition == object.yPosition){
                if(object instanceof Warrior){
                    ...
                    System.out.println("Warrior dealed " + this.damage + " damage to " + object.getClass().getName());
                    System.out.println(object.getClass().getName() + " dealed " + ((Character) object).damage + " to warrior");
                    ...
                    if(((Trap) object).stunDuration > 0){
                        ...
                        System.out.println("Warrior stepped " + object.getClass().getName());
